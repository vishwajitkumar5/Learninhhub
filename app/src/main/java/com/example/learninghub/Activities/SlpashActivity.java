...
public class SlpashActivity extends AppCompatActivity {
    ...
    private  void loadData()
    {
        ...
        firestore.collection("QUIZ4").document("Categories")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    if(doc.exists())
                    {
                        ...
                        Intent intent = new Intent(SlpashActivity.this, QuizActivity.class);
                        startActivity(intent);
                    ...
                    {
                        Toast.makeText(SlpashActivity.this,"No Category Document Exists!",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                ...
                else
                {
                    ...
                    Toast.makeText(SlpashActivity.this,task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
